...
function pixelateEffect(intensity) {
    ...
    ctx.drawImage(tempCanvas, 0, 0, canvas.width / size, canvas.height / size, 
...
function waveyEffect(intensity) {
    ...
    for (let x = 0; x < canvas.width; x++) {
        ...
        ctx.drawImage(tempCanvas, 
            x, 0, 1, canvas.height,
            x + distortX, distortY, 1, canvas.height);
    }
}
...
// Update effects when window is resized
