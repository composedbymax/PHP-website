    ...
    <main class="page-content">
        ...
        <section class="hero">
            <div class="hero-content">
                <h1>Tech / Research</h1>
                <p>Discover the science of sound, including psychoacoustics and acoustical engineering. Get access to detailed research and practical recording techniques</p>
            </div>
        </section>
